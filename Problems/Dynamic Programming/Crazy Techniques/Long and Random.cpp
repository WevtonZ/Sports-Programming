...
void test() {
     ...
     * que a quantidade de elementos a serem removidos é bem pouca a cada vez que um novo elemento é processado. Assumimos um centro da quantidade de elementos que serão removidos
     * da nossa DP, e com isso podemos melhorar muito o bound de complexidade da nossa programação dinâmica.
     * 
